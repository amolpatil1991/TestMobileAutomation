...
@CucumberOptions(
        ...
        plugin = {
                "pretty",
                "html:target/cucumber-reports/android/report.html",
                "json:target/cucumber-reports/android/report.json"
        },
        tags = "@login",
        monochrome = true
)
public class AndroidTestRunnerTest extends AbstractTestNGCucumberTests {
    @BeforeTest
